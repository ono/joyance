...
class CountersControllerTest < ActionController::TestCase
  ...
  test "should create counter" do
    assert_difference('Counter.count') do
      post :create, counter: { count: @counter.count, date: @counter.date, gender: @counter.gender, hour: @counter.hour, minute: @counter.minute, sentiment: @counter.sentiment, stream: @counter.stream }
    end
  ...
  test "should update counter" do
    put :update, id: @counter, counter: { count: @counter.count, date: @counter.date, gender: @counter.gender, hour: @counter.hour, minute: @counter.minute, sentiment: @counter.sentiment, stream: @counter.stream }
    assert_redirected_to counter_path(assigns(:counter))
  end
